		...
		<tbody>
			<c:forEach items="${prodlist}" var="pro">
				<tr>
					...
					<td><a href="${pageContext.request.contextPath}/product-detail/${pro.prodid}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">${pro.name}</a><br> Rs.${pro.price} <br>
						Description:${pro.description}<br><br><br>
